...
class GraphQNetwork(torch.nn.Module):
    def __init__(self, num_node_features, num_edge_features, seed):
        ...
        self.conv1 = GATv2Conv(num_node_features + 2 + 6 , 30, edge_dim=num_edge_features, heads=2)
        self.conv2 = GATv2Conv(75, 30, edge_dim=num_edge_features, heads=2)
        self.conv3 = GATv2Conv(135, 30, edge_dim=num_edge_features)
        self.conv4 = GATv2Conv(165, 30, edge_dim=num_edge_features)


        self.graph_embedder = torch.nn.Linear(195, 64)
        self.graph_embedder_1 = torch.nn.Linear(64, 32)
        self.graph_embedder_2 = torch.nn.Linear(32, 6)

        self.subgraph_embedder = torch.nn.Linear(195, 64)
        self.subgraph_embedder_1 = torch.nn.Linear(64, 32)
        self.subgraph_embedder_2 = torch.nn.Linear(32, 6)


        self.state_embedder = torch.nn.Linear(207, 64)
