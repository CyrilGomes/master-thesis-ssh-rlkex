...
class GraphTraversalEnv(gym.Env):
    def __init__(self, graph, target_nodes, root_node, max_episode_steps=50):
        """
    ...
    def assess_target_complexity(self):
        ...
        nb_neighbours_root = self.graph.out_degree(self.root_node)
    ...
    def _init_rewards_and_penalties(self):
        ...
        self.PROXIMITY_PENALTY = -1
        self.STEP_PENALTY = -1
        self.NO_PATH_PENALTY = -5
    ...
    def step(self, action):
        ...
        if has_found_target:
            ...
            reward += self.NO_TARGET_FOUND_PENALTY
